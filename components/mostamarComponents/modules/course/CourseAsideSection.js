    ...
    return (
        ...
        //   className='text-center bg-light mt-4 pt-2 pb-2 p-3 border rounded-pill shadow-sm'>اطلاعات دوره</span> */}
          ...
          className='text-center bg-primary text-white mt-4 pt-2 mb-2 pb-2 p-3 border rounded-pill shadow-sm'>{courseName}</span>
            ...
            <div className='d-flex border-bottom mt-2 border-top py-3 pt-4'>
            {/* <div style={{width:"100%"}} className="lbf-after-card-img my-0 mt-1 mb-3 mx-auto mx-lg-0"></div> */}
            <div style={{width:"80px" , height:"140px"}} className='d-flex border rounded shadow-sm flex-column justify-content-center align-items-center'>
            ...
            <div style={{width:"80px" , height:"120px"}} className='d-flex mx-2 mx-md-3 mx-lg-4 border rounded shadow-sm px-2 py-3 flex-column justify-content-center align-items-center'>
            ...
            <div style={{width:"80px" , height:"120px"}} className='d-flex border rounded shadow-sm px-2 py-3 flex-column justify-content-center align-items-center'>
