...
import { FaChalkboardTeacher, FaUserTie, FaGraduationCap, FaUserFriends, FaBookOpen, FaChevronDown } from "react-icons/fa";
...
// آیتم شمارنده
function CounterItem({ icon: Icon, label, endValue, showPlus = false, bgColor, textColor }) {
