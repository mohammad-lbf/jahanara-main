    ...
    return (
        <div className='container'>
            ...
            <div className='col-12 col-lg-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0'>
                <Link href={"/"}>
                <div className='hover-up-element d-flex align-items-center bg-white rounded border py-2 px-3'>
                    <Image alt='education' style={{width:"60px" , height:"60px"}} width={512} height={512} src={"/images/components/modules/tarhedars.png"} />
            ...
            <div className='col-12 col-lg-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0'>
                <Link href={"/"}>
                <div className='hover-up-element d-flex align-items-center bg-white rounded border py-2 px-3'>
                    <Image alt='teaching' style={{width:"60px" , height:"60px"}} width={512} height={512} src={"/images/components/modules/mohtavaye-amoozeshi.png"} />
            ...
            <div className='col-12 col-lg-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0'>
                <Link href={"/"}>
                <div className='hover-up-element d-flex align-items-center bg-white rounded border py-2 px-3'>
                    <Image alt='education' style={{width:"60px" , height:"60px"}} width={512} height={512} src={"/images/components/modules/darsnameh.png"} />
