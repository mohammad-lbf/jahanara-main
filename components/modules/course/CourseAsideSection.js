    ...
    return (
        <div  className='flex-column w-100 align-items-center pt-0 d-flex shadow-sm bg-white mb-lg-3 mb-2 p-3 rounded border'>
          ...
          className='text-center bg-primary text-white mt-4 pt-2 mb-2 pb-2 p-3 border rounded-pill shadow-sm'>{courseName}</span>
            ...
            <div style={{width:"80px" , height:"110px"}} className='d-flex border rounded shadow-sm flex-column justify-content-center align-items-center'>
            ...
            <div style={{width:"80px" , height:"110px"}} className='d-flex mx-2 mx-md-3 mx-lg-4 border rounded shadow-sm flex-column justify-content-center align-items-center'>
            ...
            <span className=' mt-2 fw-bold' style={{fontFamily:"Vazirmatn" , fontSize:"13px", textWrap:"nowrap"}}>{ToPersianNumber(courseTime)}</span>
            </div>
            <div style={{width:"80px" , height:"110px"}} className='d-flex border rounded shadow-sm flex-column justify-content-center align-items-center'>
            ...
            <span className=' mt-2 fw-bold' style={{fontFamily:"Vazirmatn" , fontSize:"13px", textWrap:"nowrap"}}>{ToPersianNumber(courseVideos)}</span>
            </div>
            </div>
