...
const ShareSecton = ({slug , mainTitle}) => {
  ...
  target='_blank'
  rel='noreferrer'
  href={`https://ble.ir/share/url?url=${siteDomain}/${slug}&text=${encodeURIComponent(`${mainTitle} | مقاله ای در وبسایت دبستان شهید جهان آرا`)}`}
>
...
<a
  ...
  target='_blank'
  rel='noreferrer'
  href={`https://eitaa.com/share/url?url=${siteDomain}/${slug}&text=${encodeURIComponent(`${mainTitle} | مقاله ای در وبسایت دبستان شهید جهان آرا`)}`}
>
...
{/* <a
  ...
  target='_blank'
  rel='noreferrer'
  href={`https://splus.ir/share?url=${siteDomain}/${slug}&text=${encodeURIComponent(`${mainTitle} | مقاله ای در وبسایت دبستان شهید جهان آرا`)}`}
>
