...
export async function getStaticProps() {
  const data = await import('@/DB/Hamyar DB/sevom/tarhedars');
  return {
    props: {
      data: data.default,
    },
...
const Soalat = ({ data }) => {
  ...
  return (
    <HamyarLayout>
      <Head>
        <title>طرح درس های پایه سوم | سامانه همیار دبستان شهید جهان آرا</title>
        <meta
          name="description"
          content="طرح درس‌های پایه سوم دبستان شهید جهان‌آرا شامل فایل‌های طرح درس، برنامه‌ریزی درسی و جزئیات آموزش برای معلمان و دانش‌آموزان. امکان فیلتر بر اساس درس یا طراح."
        />
        <meta name="keywords" content="طرح درس سوم دبستان, برنامه درسی سوم دبستان, محتوای درسی سوم, دبستان شهید جهان آرا, همیار" />
        ...
        <meta property="og:title" content="طرح درس های پایه سوم | سامانه همیار دبستان شهید جهان آرا" />
        <meta property="og:description" content="طرح درس‌های پایه سوم دبستان شهید جهان‌آرا شامل فایل‌های کمک‌درسی، برنامه‌ریزی درسی و جزئیات آموزش برای معلمان و دانش‌آموزان. امکان فیلتر بر اساس درس یا طراح." />
