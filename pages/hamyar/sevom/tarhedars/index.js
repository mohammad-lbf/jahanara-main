...
import data from '@/DB/Hamyar DB/sevom/tarhedars';
  ...
  return (
    <HamyarLayout>
      <Head>
        ...
        />
        <meta name="keywords" content="طرح درس سوم دبستان, برنامه درسی سوم دبستان, محتوای درسی سوم, دبستان شهید جهان آرا, همیار معلم" />
