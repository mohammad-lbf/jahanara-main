...
const Sevom = ({ soalatCount, tarhedarsCount, mohtavaCount, darsnamehCount }) => {
  const canonicalUrl = `https://jahanaraschool.ir/hamyar/sevom`;
      ...
      <div style={{ minHeight: "100vh" }} className='page-padding-tops'>
        <div
          style={{
            ...
            paddingBottom: "50px",
            backgroundColor: "#fff",
            boxShadow: "1px 3px 15px 2px rgba(224,15,50,0.89)",
          }}
          ...
          <div className='row align-items-center'>
            <div className='col-12 col-lg-7'>
              <h2
                ...
                style={{ fontSize: "25px", fontFamily: "KalamehWeb-Bold", color: "#e00f32" }}
              >
                پایه سوم دبستان
              </h2>
              <p
        ...
        <div className='container'>
          <div className='row justify-content-center'>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2 d-flex justify-content-center'>
              <ToolsMenuOption type={"soalat"} number={toPersianNumber(soalatCount)} slug="/hamyar/sevom/soalat" />
            </div>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2'>
              <ToolsMenuOption type={"tarhedars"} number={toPersianNumber(tarhedarsCount)} slug={"/hamyar/sevom/tarhedars"} />
            </div>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2'>
              <ToolsMenuOption type={"mohtava"} number={toPersianNumber(mohtavaCount)} slug={"/hamyar/sevom/mohtava"} />
            </div>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2'>
              <ToolsMenuOption type={"darsnameh"} number={toPersianNumber(darsnamehCount)} slug={"/hamyar/sevom/darsnameh"} />
            </div>
          </div>
        </div>
      </div>
