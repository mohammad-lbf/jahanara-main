...
export async function getStaticProps() {
  const data = await import('@/DB/Hamyar DB/sevom/mohtava');
  return {
    props: {
      data: data.default,
    },
...
const Mohtava = ({ data }) => {
  ...
  return (
    <HamyarLayout>
      <Head>
        <title>محتواهای آموزشی پایه سوم | سامانه همیار دبستان شهید جهان آرا</title>
        <meta
          name="description"
          content="بانک محتوای آموزشی پایه سوم دبستان شهید جهان‌آرا شامل جزوه‌ها، فایل‌های کمک درسی و محتوای متنوع برای معلمان و دانش‌آموزان. فیلتر بر اساس درس یا طراح."
        />
        <meta name="keywords" content="محتوای آموزشی سوم دبستان, جزوه سوم دبستان, محتوای درسی سوم, دبستان شهید جهان آرا, همیار" />
        ...
        <meta property="og:title" content="محتواهای آموزشی پایه سوم | سامانه همیار دبستان شهید جهان آرا" />
        <meta property="og:description" content="بانک محتوای آموزشی پایه سوم دبستان شهید جهان‌آرا شامل جزوه‌ها، فایل‌های کمک درسی و محتوای متنوع برای معلمان و دانش‌آموزان. فیلتر بر اساس درس یا طراح." />
