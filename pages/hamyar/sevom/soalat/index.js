...
const Soalat = () => {
  ...
  return (
    <HamyarLayout>
      <Head>
        <title>نمونه سوالات پایه سوم | سامانه همیار دبستان شهید جهان آرا</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="نمونه سوالات پایه سوم | سامانه همیار دبستان شهید جهان آرا" />
