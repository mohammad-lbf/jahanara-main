...
import data from '@/DB/Hamyar DB/panjom/darsnameh';
...
<div style={{minHeight:"100vh"}} className='page-padding-tops'>
            <div style={{paddingTop:"20px" , paddingBottom:"20px"}} className='container mt-5 mt-lg-2 bg-white rounded shadow-sm border'>
