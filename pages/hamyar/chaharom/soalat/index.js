...
export async function getStaticProps() {
  const data = await import('@/DB/Hamyar DB/chaharom/soalat');
  return {
    props: {
      data: data.default,
    },
...
const Soalat = ({ data }) => {
  ...
  return (
    <HamyarLayout>
      <Head>
        <title>نمونه سوالات پایه چهارم | سامانه همیار دبستان شهید جهان آرا</title>
        <meta
          name="description"
          content="در این صفحه می‌توانید به بانک نمونه سوالات پایه چهارم دبستان شهید جهان‌آرا به تفکیک درس و طراح دسترسی داشته باشید."
        />
        <meta name="keywords" content="نمونه سوالات چهارم دبستان, سوالات ابتدایی, دبستان شهید جهان آرا, سوالات امتحانی چهارم, همیار" />
        ...
        <meta property="og:title" content="نمونه سوالات پایه چهارم | سامانه همیار دبستان شهید جهان آرا" />
        <meta property="og:description" content="بانک کامل نمونه سوالات پایه چهارم دبستان شهید جهان‌آرا با امکان فیلتر بر اساس درس یا طراح سوال." />
