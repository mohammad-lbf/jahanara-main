...
export async function getStaticProps() {
  const data = await import('@/DB/Hamyar DB/chaharom/mohtava');
  return {
    props: {
      data: data.default,
    },
...
const Mohtava = ({ data }) => {
  ...
  return (
    <HamyarLayout>
      <Head>
        <title>محتواهای آموزشی پایه چهارم | سامانه همیار دبستان شهید جهان آرا</title>
        <meta
          name="description"
          content="بانک محتوای آموزشی پایه چهارم دبستان شهید جهان‌آرا شامل جزوه‌ها، فایل‌های کمک درسی و محتوای متنوع برای معلمان و دانش‌آموزان. فیلتر بر اساس درس یا طراح."
        />
        <meta name="keywords" content="محتوای آموزشی چهارم دبستان, جزوه چهارم دبستان, محتوای درسی چهارم, دبستان شهید جهان آرا, همیار" />
        ...
        <meta property="og:title" content="محتواهای آموزشی پایه چهارم | سامانه همیار دبستان شهید جهان آرا" />
        <meta property="og:description" content="بانک محتوای آموزشی پایه چهارم دبستان شهید جهان‌آرا شامل جزوه‌ها، فایل‌های کمک درسی و محتوای متنوع برای معلمان و دانش‌آموزان. فیلتر بر اساس درس یا طراح." />
        <meta property="og:url" content={canonicalUrl} />
        <meta property="og:site_name" content="دبستان شهید جهان آرا" />
        <meta name="twitter:title" content="محتواهای آموزشی پایه چهارم | سامانه همیار دبستان شهید جهان آرا" />
        <meta name="twitter:description" content="بانک محتوای آموزشی پایه چهارم دبستان شهید جهان‌آرا شامل جزوه‌ها، فایل‌های کمک درسی و محتوای متنوع برای معلمان و دانش‌آموزان. فیلتر بر اساس درس یا طراح." />
