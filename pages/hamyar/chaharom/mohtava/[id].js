...
const Page = ({ currentFileData, data }) => {
  ...
  const pageKeywords = `محتوای آموزشی, محتوای آموزشی پایه چهارم, دبستان شهید جهان آرا, ${currentFileData.name}`;
  const canonicalUrl = `https://jahanaraschool.ir/hamyar/chaharom/mohtava/${currentFileData.id}`;
      ...
      <Head>
        ...
        <div style={{minHeight:"100vh"}} className='page-padding-tops'>
            <div style={{paddingTop:"20px" , paddingBottom:"20px"}} className='mt-5 mt-lg-2 container bg-white rounded shadow-sm border'>
                ...
                <i class="bi bi-chevron-left mx-2"></i>
                <Link href={"/hamyar/chaharom/mohtava"} style={{fontFamily:"KalamehWeb-Bold"}}>
                    محتوای آموزشی
                </Link>
                </div>
            </div>
            ...
            <div className='container'>
                ...
                آخرین محتوا های آموزشی پایه چهارم
                </h2>
                </div>
