...
import data from '@/DB/Hamyar DB/chaharom/darsnameh';
...
const Page = ({ currentFileData, data }) => {
  ...
  const pageKeywords = `درسنامه آموزشی, درسنامه پایه چهارم, دبستان شهید جهان آرا, ${currentFileData.name}`;
  const canonicalUrl = `https://jahanaraschool.ir/hamyar/chaharom/darsnameh/${currentFileData.id}`;
      ...
      <div style={{minHeight:"100vh"}} className='page-padding-tops'>
        <div style={{paddingTop:"20px" , paddingBottom:"20px"}} className='mt-5 mt-lg-2 container bg-white rounded shadow-sm border'>
          <div className='d-flex'>
            ...
            <i className="bi bi-chevron-left mx-2"></i>
            <Link href={"/hamyar/chaharom"} style={{fontFamily:"KalamehWeb-Bold"}}>
              چهارم
            </Link>
            <i className="bi bi-chevron-left mx-2"></i>
            <Link href={"/hamyar/chaharom/darsnameh"} style={{fontFamily:"KalamehWeb-Bold"}}>
              درسنامه آموزشی
            </Link>
          </div>
        </div>
              ...
              <div className='container'>
                <div style={{ paddingTop:"20px" , paddingBottom:"20px"}} className='mb-3 container bg-white rounded text-center shadow-sm border'>
                  <h2 style={{fontFamily:"KalamehWeb-Bold" , fontSize:"17px"}} className="text-center">
                    آخرین درسنامه های آموزشی پایه چهارم
                  </h2>
                </div>
