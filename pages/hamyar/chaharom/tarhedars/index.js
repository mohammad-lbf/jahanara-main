...
export async function getStaticProps() {
  const data = await import('@/DB/Hamyar DB/chaharom/tarhedars');
  return {
    props: {
      data: data.default,
    },
...
const Soalat = ({ data }) => {
  ...
  return (
    <HamyarLayout>
      <Head>
        <title>طرح درس های پایه چهارم | سامانه همیار دبستان شهید جهان آرا</title>
        <meta
          name="description"
          content="طرح درس‌های پایه چهارم دبستان شهید جهان‌آرا شامل فایل‌های طرح درس، برنامه‌ریزی درسی و جزئیات آموزش برای معلمان و دانش‌آموزان. امکان فیلتر بر اساس درس یا طراح."
        />
        <meta name="keywords" content="طرح درس چهارم دبستان, برنامه درسی چهارم دبستان, محتوای درسی چهارم, دبستان شهید جهان آرا, همیار" />
        ...
        <meta property="og:title" content="طرح درس های پایه چهارم | سامانه همیار دبستان شهید جهان آرا" />
        <meta property="og:description" content="طرح درس‌های پایه چهارم دبستان شهید جهان‌آرا شامل فایل‌های کمک‌درسی، برنامه‌ریزی درسی و جزئیات آموزش برای معلمان و دانش‌آموزان. امکان فیلتر بر اساس درس یا طراح." />
        <meta property="og:url" content={canonicalUrl} />
        <meta property="og:site_name" content="دبستان شهید جهان آرا" />

        <meta name="twitter:title" content="طرح درس های پایه چهارم | سامانه همیار دبستان شهید جهان آرا" />
        <meta name="twitter:description" content="طرح درس‌های پایه چهارم دبستان شهید جهان‌آرا شامل فایل‌های کمک‌درسی، برنامه‌ریزی درسی و جزئیات آموزش برای معلمان و دانش‌آموزان. امکان فیلتر بر اساس درس یا طراح." />
        ...
        <div style={{ marginTop: "50px", paddingTop: "20px", paddingBottom: "20px" }} className="container bg-white rounded shadow border">
          <div className="row align-items-center">
            ...
            <div className="col-12 col-lg-5 text-center text-lg-start">
              <Image className="mt-3 mt-lg-0" style={{ width: "50px", height: "50px" }} src={"/images/hamyar/components/modules/number-4.png"} height={512} width={512} alt="پایه چهارم" />
            </div>
          </div>
        </div>
