...
<div style={{minHeight:"100vh"}} className='page-padding-tops'>
    ...
    <div className='row align-items-center'>
            ...
            <div className='col-12 col-lg-5 text-center text-lg-start'>
                    <Image style={{width:"100px" , height:"100px"}} src={"/images/hamyar/components/modules/number-6.png"} height={512} width={512} />
            </div>
    </div>
</div>
        ...
        <div className='row justify-content-center'>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0 d-flex justify-content-center'>
                <ToolsMenuOption type={"soalat"} number={soalat.length} slug="/hamyar/sheshom/soalat" />
            </div>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0'>
                    <ToolsMenuOption type={"tarhedars"} number={tarhedars.length} slug={"/hamyar/sheshom/tarhedars"} />
            </div>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0'>
                    <ToolsMenuOption type={"mohtava"} number={mohtava.length} slug={"/hamyar/sheshom/mohtava"} />
            </div>
            <div className='col-12 col-sm-6 col-xl-4 col-xxl-3 mb-4 mt-2 mb-lh-0'>
                <ToolsMenuOption type={"darsnameh"} number={darsnameh.length} slug={"/hamyar/sheshom/darsnameh"}  />
            </div>
        </div>
        </div>
