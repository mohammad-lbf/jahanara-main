...
import data from '@/DB/Hamyar DB/sheshom/tarhedars';
...
const Page = ({ currentFileData, data }) => {
  ...
  const pageKeywords = `طرح درس, طرح درس های پایه ششم, دبستان شهید جهان آرا, ${currentFileData.name}`;
  const canonicalUrl = `https://jahanaraschool.ir/hamyar/sheshom/tarhedars/${currentFileData.id}`;
