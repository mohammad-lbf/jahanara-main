...
export async function getStaticProps() {
  const data = await import('@/DB/Hamyar DB/sheshom/darsnameh/index');
  return {
    props: {
      data: data.default,
    },
...
const Darsnameh = ({ data }) => {
  ...
  return (
    <HamyarLayout>
      <Head>
        <title>درسنامه‌های آموزشی پایه ششم | سامانه همیار دبستان شهید جهان آرا</title>
        <meta
          name="description"
          content="بانک کامل درسنامه‌های آموزشی پایه ششم دبستان شهید جهان‌آرا با امکان فیلتر بر اساس درس یا طراح. محتوای آموزشی باکیفیت ویژه معلمان و دانش‌آموزان."
        />
        <meta name="keywords" content="درسنامه ششم دبستان, درسنامه آموزشی, دبستان شهید جهان آرا, محتوای آموزشی ششم, همیار" />
        ...
        <meta property="og:title" content="درسنامه‌های آموزشی پایه ششم | سامانه همیار دبستان شهید جهان آرا" />
        <meta property="og:description" content="بانک کامل درسنامه‌های آموزشی پایه ششم دبستان شهید جهان‌آرا با امکان فیلتر بر اساس درس یا طراح. محتوای آموزشی باکیفیت ویژه معلمان و دانش‌آموزان." />
        <meta property="og:url" content={canonicalUrl} />
        <meta property="og:site_name" content="دبستان شهید جهان آرا" />

        <meta name="twitter:title" content="درسنامه‌های آموزشی پایه ششم | سامانه همیار دبستان شهید جهان آرا" />
        <meta name="twitter:description" content="بانک کامل درسنامه‌های آموزشی پایه ششم دبستان شهید جهان‌آرا با امکان فیلتر بر اساس درس یا طراح. محتوای آموزشی باکیفیت ویژه معلمان و دانش‌آموزان." />
      </Head>
